  ...
  return (
    <div className={styles.page}>
      ...
      <nav className={styles.navbar}>
        <div className={styles.navContainer}>
          <div className={styles.navBrand} onClick={() => scrollTo('hero')}>
            <img src={logoImg} alt="App Síndico" className={styles.navLogoImg} style={{ width: 48, height: 48, borderRadius: 10, objectFit: 'contain' }} />
          </div>
      ...
      <section id="diferenciais" className={styles.diferenciais}>
        <div className={styles.sectionContainer}>
          <div className={styles.sectionHeader}>
            <span className={styles.sectionTag} style={{ background: 'rgba(255,255,255,0.2)', color: '#fff' }}>Por que escolher o App Síndico?</span>
      ...
      <footer className={styles.footer}>
        <div className={styles.footerContainer}>
          <div className={styles.footerBrand}>
            <img src={logoImg} alt="App Síndico" className={styles.navLogoImg} style={{ width: 48, height: 48, borderRadius: 10, objectFit: 'contain' }} />
            <span className={styles.navName}>App <span className={styles.navDestaque}>Síndico</span></span>
          </div>
          <p className={styles.footerCopy}>
            © {new Date().getFullYear()} App Síndico — Sistema de Gestão Condominial
          </p>
        </div>
      </footer>
    </div>
